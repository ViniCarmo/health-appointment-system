    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/appointments/*/cancel").hasAnyRole("DOCTOR", "NURSE")
                        .requestMatchers(HttpMethod.POST, "/api/v1/appointments/*/complete").hasAnyRole("DOCTOR", "NURSE")
