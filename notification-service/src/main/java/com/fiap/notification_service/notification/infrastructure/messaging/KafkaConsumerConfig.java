...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, AppointmentEvent> appointmentEventConsumerFactory() {
        ...
        // o header __TypeId__ do produtor aponta para a classe do scheduling-service,
        // que nem existe aqui - ignoramos o header e sempre desserializamos
        // para o nosso proprio AppointmentEvent.
